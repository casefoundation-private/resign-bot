...
Review.propTypes = {
  ...
  setReviewPromptValue: PropTypes.func.isRequired,
  updateReview: PropTypes.func.isRequired,
  calculateAndUpdateReview: PropTypes.func.isRequired,
  setReviewFlagged: PropTypes.func.isRequired,
  setReviewCategoryValue: PropTypes.func.isRequired,
  reviews: PropTypes.shape({
    ...
    validation: PropTypes.shape({
      invalidPrompts: PropTypes.array,
